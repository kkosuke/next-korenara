export const dummyItem = {
  ...
  userUid: "A5bjN7wmJqOc7acXQhd2EOHBiii2",
  user: {
    id: 1,
    name: "ユーザー名",
    image:
  ...
  editedAt: "2023-04-02",
  detail:
    "説明文が入ります。説明文が入ります。説明文が入ります。説明文が入ります。説明文が入ります。説明文が入ります。説明文が入ります。説明文が入ります。説明文が入ります。説明文が入ります。説明文が入ります。説明文が入ります。説明文が入ります。",
  price: 4999,
  category: [1, 2],
  tags: ["ダミータグ1", "ダミータグ2"],
};
